...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 381.0, 110.0, 60.0, 22.0 ],
					"text" : "zl.change"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 465.0, 149.0, 22.0 ],
					"text" : "mc.pack~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 385.0, 84.0, 22.0 ],
					"text" : "mc.unpack~ 2"
				}
...
,
					"patching_rect" : [ 30.0, 425.0, 149.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 91.0, 568.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.5, 15.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 281.0, 31.0, 22.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 381.0, 83.0, 75.0, 22.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "" ],
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 307.0, 19.0, 56.0, 22.0 ],
					"restore" : 					{
						"gain" : [ 0.0 ],
						"pan" : [ 0.5 ]
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 568.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 30.0, 508.0, 152.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 160.0, 383.0, 26.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 281.0, 32.0, 22.0 ],
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 354.0, 136.0, 22.0 ],
					"text" : "mcs.play~ #0-samp 2"
				}
...
, 			{
				"box" : 				{
					...
					"snapto" : 1,
					"vticks" : 0,
					"waveformcolor" : [ 0.976, 0.518, 0.29, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 39.5, 267.0, 15.0, 267.0, 15.0, 555.0, 100.5, 555.0 ],
					"order" : 0,
					"source" : [ "obj-27", 0 ]
				}
